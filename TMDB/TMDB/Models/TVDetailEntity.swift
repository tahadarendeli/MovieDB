...
class TVDetailEntity: ShowDetailEntity {
    ...
    class func getItem(endPoint: String, result:@escaping (TVDetailEntity?)->()){
        
        var item = TVDetailEntity()
    ...
    class func parseJson(json : JSON) -> TVDetailEntity {
        let ent = TVDetailEntity()
